...
# write.csv(cryptic_df_coord,"output_tables/cryptic_df_coord_seqFill.csv")
...
# write.csv(cryptic_df_coord,"output_tables/250412_cryptic_df_coord_UGrepcalc.csv")
...
# write.csv(mathUG_df_L, "output_tables/250412_cryptic_df_UG_freq_L.csv")
# write.csv(mathUG_df_R, "output_tables/250412_cryptic_df_UG_freq_R.csv")



ggplot(mathUG_df_R, aes(x=loc,y=avg))+geom_line(linewidth = 2,colour = "#69140E")+
  theme_classic()+
