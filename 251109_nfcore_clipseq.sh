...
for file in 251106_*; do \
  ...
  # Set barcode
  [[ "$fName" = "50" ]] && barcode="NNNXXXXNN"
  [[ "$fName" = "51" ]] && barcode="NNXXNNXXX"
  [[ "$fName" = "52" ]] && barcode="NNXXNNXXX"
  [[ "$fName" = "53" ]] && barcode="NNNXXXXNN"
  [[ "$fName" = "54" ]] && barcode="NNNXXXXNN"
  [[ "$fName" = "55" ]] && barcode="XXNNN"
